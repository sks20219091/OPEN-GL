...
def window_input():
	...
	x_min=int(input("Enter lower x coordinate: "))
	y_min=int(input("Enter lower y coordinate: "))
	x_max=int(input("Enter higher x coordinate: "))
	y_max=int(input("Enter higher y coordinate: "))
def window_draw():
...
def polygon_input():
	...
	for i in range(n):
		x_vertex.append(int(input("Enter x_coordinate: ")))
		y_vertex.append(int(input("Enter y_coordinate: ")))
