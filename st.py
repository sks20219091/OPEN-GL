...
def readvertices():
	...
	x0=int(input("Enter 1st_x: "))
	y0=int(input("Enter 1st_y: "))
	x1=int(input("Enter 2nd_x: "))
	y1=int(input("Enter 2nd_y: "))
	x2=int(input("Enter 3rd_x: "))
	y2=int(input("Enter 3rd_y: "))
	n=int(input("Enter level of sierpensky: "))
